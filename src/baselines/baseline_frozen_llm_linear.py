"""
Baseline 2: Frozen LLM + Linear Classifier

Uses base Qwen model (no pretraining) with frozen parameters, trains only linear head.
"""
import os
import torch
import numpy as np
...
class FrozenLLMLinearBaseline:
    """
    Frozen base LLM with trainable linear classification head.
    """
    
    def __init__(self, config: Dict[str, Any]):
        """
        Initialize the frozen LLM + linear baseline.
    ...
    def create_classifier(self):
        """Create LLMClassifier with frozen base model."""
        print("\n" + "=" * 80)
        print("Creating frozen LLM + linear classifier...")
        print("=" * 80)
        ...
        self.classifier_model = LLMClassifier(
            ...
            trainable_param_keywords=[],  # Don't train any LoRA adapters
    ...
    def run(self):
        ...
        print("\n" + "=" * 80)
        print("Frozen LLM + Linear Baseline Complete!")
        print("=" * 80)
